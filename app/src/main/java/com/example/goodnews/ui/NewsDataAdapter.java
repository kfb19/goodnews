...
public class NewsDataAdapter extends RecyclerView.Adapter<NewsDataAdapter.ViewHolder>{
    ...
    public NewsDataAdapter(NewsData[] listdata) {
        this.listdata = listdata;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.news_view_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final NewsData myListData = listdata[position];
